...
game = Soccer_Game()
q_error, q_error1, q_error2, qTableA, qTableB  = CEQ(game, 0.9, 0.8, 500000)
#np.save("CEQcopy_q_a_list", q_error)
#np.save("CEQcopy_q_a_list1", q_error1)
np.save("CEQcopy_q_a_list2", q_error2)
np.save("CEQcopy_qTableA", qTableA)
np.save("CEQcopy_qTableB", qTableB)
plot(np.array(q_error2), "Correlated_Q", "Correlated_Qcopy")